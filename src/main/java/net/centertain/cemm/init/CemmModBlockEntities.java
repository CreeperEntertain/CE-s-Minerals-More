...
public class CemmModBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<?>> OIL_GENERATOR = register("oil_generator", CemmModBlocks.OIL_GENERATOR, OilGeneratorBlockEntity::new);
	public static final RegistryObject<BlockEntityType<?>> IRON_SCAFFOLDING = register("iron_scaffolding", CemmModBlocks.IRON_SCAFFOLDING, IronScaffoldingBlockEntity::new);
	public static final RegistryObject<BlockEntityType<?>> COPPER_SCAFFOLDING = register("copper_scaffolding", CemmModBlocks.COPPER_SCAFFOLDING, CopperScaffoldingBlockEntity::new);
	public static final RegistryObject<BlockEntityType<?>> SOLID_IRON_SCAFFOLDING = register("solid_iron_scaffolding", CemmModBlocks.SOLID_IRON_SCAFFOLDING, SolidIronScaffoldingBlockEntity::new);
	public static final RegistryObject<BlockEntityType<?>> SOLID_COPPER_SCAFFOLDING = register("solid_copper_scaffolding", CemmModBlocks.SOLID_COPPER_SCAFFOLDING, SolidCopperScaffoldingBlockEntity::new);
	public static final RegistryObject<BlockEntityType<?>> AMBER_SENTINEL_SAPLING = register("amber_sentinel_sapling", CemmModBlocks.AMBER_SENTINEL_SAPLING, AmberSentinelSaplingBlockEntity::new);
	public static final RegistryObject<BlockEntityType<?>> WOODEN_CRATE = register("wooden_crate", CemmModBlocks.WOODEN_CRATE, WoodenCrateBlockEntity::new);
	public static final RegistryObject<BlockEntityType<?>> BLACKSTONE_TARGET = register("blackstone_target", CemmModBlocks.BLACKSTONE_TARGET, BlackstoneTargetBlockEntity::new);
	public static final RegistryObject<BlockEntityType<?>> BLOCK_REFINERY = register("block_refinery", CemmModBlocks.BLOCK_REFINERY, BlockRefineryBlockEntity::new);
	public static final RegistryObject<BlockEntityType<?>> XP_STORAGE_FULL = register("xp_storage_full", CemmModBlocks.XP_STORAGE_FULL, XPStorageFullBlockEntity::new);
	public static final RegistryObject<BlockEntityType<?>> ROPE_BOX = register("rope_box", CemmModBlocks.ROPE_BOX, RopeBoxBlockEntity::new);
	public static final RegistryObject<BlockEntityType<?>> DOCK_CRATE = register("dock_crate", CemmModBlocks.DOCK_CRATE, DockCrateBlockEntity::new);
	public static final RegistryObject<BlockEntityType<?>> ROPED_DOCK_CRATE = register("roped_dock_crate", CemmModBlocks.ROPED_DOCK_CRATE, RopedDockCrateBlockEntity::new);
	public static final RegistryObject<BlockEntityType<?>> CHUTE = register("chute", CemmModBlocks.CHUTE, ChuteBlockEntity::new);
	public static final RegistryObject<BlockEntityType<?>> WOODEN_BIN = register("wooden_bin", CemmModBlocks.WOODEN_BIN, WoodenBinBlockEntity::new);
	public static final RegistryObject<BlockEntityType<?>> FAN = register("fan", CemmModBlocks.FAN, FanBlockEntity::new);
	public static final RegistryObject<BlockEntityType<?>> DARK_BAMBOO = register("dark_bamboo", CemmModBlocks.DARK_BAMBOO, DarkBambooBlockEntity::new);
