		...
		for (LevelStem levelStem : levelStemTypeRegistry.stream().toList()) {
			...
			if (dimensionType == dimensionTypeRegistry.getOrThrow(BuiltinDimensionTypes.OVERWORLD)) {
				...
				if (chunkGenerator.getBiomeSource() instanceof MultiNoiseBiomeSource noiseSource) {
					...
					parameters.add(new Pair<>(new Climate.ParameterPoint(Climate.Parameter.span(-0.4f, 1.23874f), Climate.Parameter.span(-0.876345f, 0.6046f), Climate.Parameter.span(0f, 1.2f), Climate.Parameter.span(-0.78345f, 0.54358f),
					...
					parameters.add(new Pair<>(new Climate.ParameterPoint(Climate.Parameter.span(0.5129f, 0.7533333333f), Climate.Parameter.span(0.18f, 0.52f), Climate.Parameter.span(-1f, 1f), Climate.Parameter.span(-0.52f, 0.4773f),
					...
					parameters.add(new Pair<>(new Climate.ParameterPoint(Climate.Parameter.span(0.5f, 1f), Climate.Parameter.span(-1f, 0f), Climate.Parameter.span(0f, 1f), Climate.Parameter.span(-0.4f, 1f), Climate.Parameter.point(1.0f),
							Climate.Parameter.span(-1f, 1f), 0), biomeRegistry.getHolderOrThrow(ResourceKey.create(Registries.BIOME, new ResourceLocation("cemm", "red_wastes")))));
					parameters.add(new Pair<>(new Climate.ParameterPoint(Climate.Parameter.span(0.61388f, 1.223214f), Climate.Parameter.span(-0.9821f, 1.2f), Climate.Parameter.span(-0.2141f, -0.09123f), Climate.Parameter.span(-0.6f, 0.6029f),
					...
					parameters
							.add(new Pair<>(new Climate.ParameterPoint(Climate.Parameter.span(-0.238784f, 0.45f), Climate.Parameter.span(-0.3217723f, 0.2087f), Climate.Parameter.span(-0.061253f, 0.7153f), Climate.Parameter.span(-0.86734f, 0.82345f),
					...
					parameters.add(new Pair<>(new Climate.ParameterPoint(Climate.Parameter.span(-2f, -0.8f), Climate.Parameter.span(-2f, 0.75f), Climate.Parameter.span(-0.11f, 0.3f), Climate.Parameter.span(-1.57845f, 0.75f),
				...
				if (chunkGenerator instanceof NoiseBasedChunkGenerator noiseGenerator) {
					...
					if (currentRuleSource instanceof SurfaceRules.SequenceRuleSource sequenceRuleSource) {
						...
						surfaceRules.add(1, preliminarySurfaceRule(ResourceKey.create(Registries.BIOME, new ResourceLocation("cemm", "hot_springs")), CemmModBlocks.SALT_BLOCK.get().defaultBlockState(),
								CemmModBlocks.SALT_BLOCK.get().defaultBlockState(), CemmModBlocks.SALT_BLOCK.get().defaultBlockState()));
						surfaceRules.add(1, preliminarySurfaceRule(ResourceKey.create(Registries.BIOME, new ResourceLocation("cemm", "amber_forest")), Blocks.GRASS_BLOCK.defaultBlockState(), Blocks.DIRT.defaultBlockState(),
								CemmModBlocks.BANK_RUN_GRAVEL.get().defaultBlockState()));
						surfaceRules.add(1, preliminarySurfaceRule(ResourceKey.create(Registries.BIOME, new ResourceLocation("cemm", "permafrost")), CemmModBlocks.SNOWED_PACKED_ICE.get().defaultBlockState(), Blocks.PACKED_ICE.defaultBlockState(),
								CemmModBlocks.FROZEN_DIRT.get().defaultBlockState()));
