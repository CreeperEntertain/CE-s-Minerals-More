...
public class CemmModCompostableItems {
	...
	public static void addComposterItems(FMLCommonSetupEvent event) {
		...
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.ALGAE.get().asItem(), 0.5f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.DECAYING_ALGAE.get().asItem(), 0.4f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.DECAYED_ALGAE.get().asItem(), 0.3f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.DYING_ALGAE.get().asItem(), 0.2f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.DEAD_ALGAE.get().asItem(), 0.1f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.WINDSWEPT_SAPLING.get().asItem(), 0.3f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.WINEWOOD_SAPLING.get().asItem(), 0.3f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.WINTER_OAK_SAPLING.get().asItem(), 0.3f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.WINDSWEPT_LEAVES.get().asItem(), 0.3f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.WINEWOOD_LEAVES.get().asItem(), 0.3f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.WINTER_OAK_LEAVES.get().asItem(), 0.3f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.WARPED_MOSS_CARPET.get().asItem(), 0.3f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.CRIMSON_MOSS_CARPET.get().asItem(), 0.3f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.WARPED_BUSH.get().asItem(), 0.6f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.CRIMSON_BUSH.get().asItem(), 0.6f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.WINDSWEPT_SHRUB.get().asItem(), 0.3f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.CRIMSON_GRASS.get().asItem(), 0.3f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.CRIMSON_SHRUB.get().asItem(), 0.3f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.SYRINGIA.get().asItem(), 0.3f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.WARPED_SHRUB.get().asItem(), 0.3f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.WARPED_PETALS.get().asItem(), 0.3f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.WARPED_BOUQUET.get().asItem(), 0.3f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.SNAPPER_FLOWER.get().asItem(), 0.65f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.SPIDER_SUCCULENT_BLADES.get().asItem(), 0.3f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.DEAD_SPIDER_SUCCULENT_BLADES.get().asItem(), 0.3f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.ADULT_ELDER.get().asItem(), 0.65f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.ELDER.get().asItem(), 0.65f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.SPARSE_ELDER.get().asItem(), 0.65f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.LUSH_ELDER.get().asItem(), 0.65f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.DAFFODIL.get().asItem(), 0.65f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.DAYLILY.get().asItem(), 0.65f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.HOUSTONIA.get().asItem(), 0.65f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.PAEONIA.get().asItem(), 0.65f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.WHITE_ORCHID.get().asItem(), 0.65f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.SEA_BUCKTHORN.get().asItem(), 0.3f);
		ComposterBlock.COMPOSTABLES.put(Items.POISONOUS_POTATO, 1f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.RED_POLYPORE.get().asItem(), 0.65f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.GROUNDED_RED_POLYPORE.get().asItem(), 0.65f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.RED_SEAGRASS.get().asItem(), 0.45f);
		ComposterBlock.COMPOSTABLES.put(CemmModBlocks.DARK_BAMBOO_SHOOT.get().asItem(), 0.3f);
	}
}
