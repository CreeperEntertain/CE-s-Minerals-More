...
import net.centertain.cemm.world.features.ShellcoastDarkBambooFeature;
...
public class CemmModFeatures {
	...
	public static final RegistryObject<Feature<?>> SHELLCOAST_DARK_BAMBOO = REGISTRY.register("shellcoast_dark_bamboo", ShellcoastDarkBambooFeature::new);
}
