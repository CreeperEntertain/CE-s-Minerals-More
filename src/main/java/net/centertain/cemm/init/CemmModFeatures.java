...
import net.centertain.cemm.world.features.plants.VanillaVineFeature;
import net.centertain.cemm.world.features.plants.TussockFeature;
...
import net.centertain.cemm.world.features.plants.SwampflowerFeature;
import net.centertain.cemm.world.features.plants.SwampSedgeFeature;
...
import net.centertain.cemm.world.features.plants.ShrubFeature;
...
import net.centertain.cemm.world.features.plants.RedSpiderLilyFeature;
...
import net.centertain.cemm.world.features.plants.NettleFeature;
import net.centertain.cemm.world.features.plants.LushFernFeature;
import net.centertain.cemm.world.features.plants.LavendarFeature;
import net.centertain.cemm.world.features.plants.LarkspurFeature;
import net.centertain.cemm.world.features.plants.HortensiaFeature;
import net.centertain.cemm.world.features.plants.HibiscusFeature;
import net.centertain.cemm.world.features.plants.GentianFeature;
import net.centertain.cemm.world.features.plants.FuchsiaFeature;
import net.centertain.cemm.world.features.plants.FoxgloveFeature;
import net.centertain.cemm.world.features.plants.ForsythiaFeature;
import net.centertain.cemm.world.features.plants.FlowerlessCactusFeature;
import net.centertain.cemm.world.features.plants.DuneGrassFeature;
import net.centertain.cemm.world.features.plants.DesertPrimroseFeature;
import net.centertain.cemm.world.features.plants.DenseFernFeature;
import net.centertain.cemm.world.features.plants.DenseDuneGrassFeature;
...
import net.centertain.cemm.world.features.plants.ChineseLanternFeature;
import net.centertain.cemm.world.features.plants.ButterflyWeedFeature;
import net.centertain.cemm.world.features.plants.BushPlantFeature;
import net.centertain.cemm.world.features.plants.BlueSageFeature;
import net.centertain.cemm.world.features.plants.BloomingSwampflowerFeature;
...
import net.centertain.cemm.world.features.plants.AmberBushFeature;
import net.centertain.cemm.world.features.plants.AloeVeraFeature;
import net.centertain.cemm.world.features.plants.AbeliaFeature;
...
import net.centertain.cemm.world.features.ores.OvergrownMarbleFeature;
...
import net.centertain.cemm.world.features.UndergroundSlagFeatureFeature;
...
import net.centertain.cemm.world.features.SiltSoilFeatureFeature;
...
import net.centertain.cemm.world.features.SavannaScorchedDirtFeatureFeature;
import net.centertain.cemm.world.features.SavannaCoarseDirtFeatureFeature;
import net.centertain.cemm.world.features.SandySoilGenerationFeature;
...
import net.centertain.cemm.world.features.QuartzSandDistributionFeature;
...
import net.centertain.cemm.world.features.PermafrostSnowSurfaceFeatureFeature;
import net.centertain.cemm.world.features.PermafrostRockFeatureFeature;
import net.centertain.cemm.world.features.PermafrostPackedIceFeatureFeature;
import net.centertain.cemm.world.features.PermafrostKyaniteDistributionFeature;
import net.centertain.cemm.world.features.PermafrostIcySnowMountainCoverageFeature;
import net.centertain.cemm.world.features.PermafrostIceCliffsFeature;
import net.centertain.cemm.world.features.PermafrostBlueIceFeatureFeature;
import net.centertain.cemm.world.features.PermafrostBlackIceFeatureFeature;
...
import net.centertain.cemm.world.features.NetherSlagFeatureFeature;
import net.centertain.cemm.world.features.NetherRubyDistributionFeature;
...
import net.centertain.cemm.world.features.MountainLaurelGeneratorFeature;
...
import net.centertain.cemm.world.features.LigniteFlatsDirtyMudFeature;
...
import net.centertain.cemm.world.features.KaolinSavannahRocksFeature;
import net.centertain.cemm.world.features.KaolinSavannahBlobsFeature;
...
import net.centertain.cemm.world.features.HotSpringsWaterDeltasFeature;
import net.centertain.cemm.world.features.HotSpringsSeaSaltFeature;
import net.centertain.cemm.world.features.HotSpringsMagmaFeature;
import net.centertain.cemm.world.features.HotSpringsLimestoneBlobsFeature;
import net.centertain.cemm.world.features.HotSpringsDripstoneFeature;
import net.centertain.cemm.world.features.HotSpringsCalciteFeature;
import net.centertain.cemm.world.features.HotSpringsBasaltFeature;
...
import net.centertain.cemm.world.features.DriedMudFeatureFeature;
import net.centertain.cemm.world.features.DirtyMudFeatureFeature;
...
import net.centertain.cemm.world.features.AmberSentinelGeneratorFeature;
import net.centertain.cemm.world.features.AmberForestSoapstoneBlobsFeature;
import net.centertain.cemm.world.features.AmberForestOrangeSchistRockFeature;
import net.centertain.cemm.world.features.AmberForestOrangeSchistBlobsFeature;
import net.centertain.cemm.world.features.AmberForestOrangeMarbleRocksFeature;
import net.centertain.cemm.world.features.AmberForestLeafCarpetsFeature;
import net.centertain.cemm.world.features.AmberForestCitrineDistributionFeature;
import net.centertain.cemm.world.features.AmberForestAdditionalLapisOreFeature;
...
public class CemmModFeatures {
	...
	public static final RegistryObject<Feature<?>> DUNE_GRASS = REGISTRY.register("dune_grass", DuneGrassFeature::new);
	public static final RegistryObject<Feature<?>> DENSE_DUNE_GRASS = REGISTRY.register("dense_dune_grass", DenseDuneGrassFeature::new);
	public static final RegistryObject<Feature<?>> DENSE_FERN = REGISTRY.register("dense_fern", DenseFernFeature::new);
	public static final RegistryObject<Feature<?>> LUSH_FERN = REGISTRY.register("lush_fern", LushFernFeature::new);
	public static final RegistryObject<Feature<?>> NETTLE = REGISTRY.register("nettle", NettleFeature::new);
	public static final RegistryObject<Feature<?>> BUSH_PLANT = REGISTRY.register("bush_plant", BushPlantFeature::new);
	...
	public static final RegistryObject<Feature<?>> TUSSOCK = REGISTRY.register("tussock", TussockFeature::new);
	public static final RegistryObject<Feature<?>> SWAMP_SEDGE = REGISTRY.register("swamp_sedge", SwampSedgeFeature::new);
	...
	public static final RegistryObject<Feature<?>> SWAMPFLOWER = REGISTRY.register("swampflower", SwampflowerFeature::new);
	public static final RegistryObject<Feature<?>> BLOOMING_SWAMPFLOWER = REGISTRY.register("blooming_swampflower", BloomingSwampflowerFeature::new);
	public static final RegistryObject<Feature<?>> RED_SPIDER_LILY = REGISTRY.register("red_spider_lily", RedSpiderLilyFeature::new);
	public static final RegistryObject<Feature<?>> GENTIAN = REGISTRY.register("gentian", GentianFeature::new);
	public static final RegistryObject<Feature<?>> CHINESE_LANTERN = REGISTRY.register("chinese_lantern", ChineseLanternFeature::new);
	public static final RegistryObject<Feature<?>> LAVENDAR = REGISTRY.register("lavendar", LavendarFeature::new);
	public static final RegistryObject<Feature<?>> FORSYTHIA = REGISTRY.register("forsythia", ForsythiaFeature::new);
	public static final RegistryObject<Feature<?>> ABELIA = REGISTRY.register("abelia", AbeliaFeature::new);
	public static final RegistryObject<Feature<?>> FOXGLOVE = REGISTRY.register("foxglove", FoxgloveFeature::new);
	public static final RegistryObject<Feature<?>> HIBISCUS = REGISTRY.register("hibiscus", HibiscusFeature::new);
	public static final RegistryObject<Feature<?>> VANILLA_VINE = REGISTRY.register("vanilla_vine", VanillaVineFeature::new);
	public static final RegistryObject<Feature<?>> FUCHSIA = REGISTRY.register("fuchsia", FuchsiaFeature::new);
	public static final RegistryObject<Feature<?>> LARKSPUR = REGISTRY.register("larkspur", LarkspurFeature::new);
	public static final RegistryObject<Feature<?>> BUTTERFLY_WEED = REGISTRY.register("butterfly_weed", ButterflyWeedFeature::new);
	public static final RegistryObject<Feature<?>> HORTENSIA = REGISTRY.register("hortensia", HortensiaFeature::new);
	public static final RegistryObject<Feature<?>> BLUE_SAGE = REGISTRY.register("blue_sage", BlueSageFeature::new);
	public static final RegistryObject<Feature<?>> AMBER_BUSH = REGISTRY.register("amber_bush", AmberBushFeature::new);
	...
	public static final RegistryObject<Feature<?>> OVERGROWN_MARBLE = REGISTRY.register("overgrown_marble", OvergrownMarbleFeature::new);
	...
	public static final RegistryObject<Feature<?>> UNDERGROUND_SLAG_FEATURE = REGISTRY.register("underground_slag_feature", UndergroundSlagFeatureFeature::new);
	public static final RegistryObject<Feature<?>> NETHER_SLAG_FEATURE = REGISTRY.register("nether_slag_feature", NetherSlagFeatureFeature::new);
	...
	public static final RegistryObject<Feature<?>> SANDY_SOIL_GENERATION = REGISTRY.register("sandy_soil_generation", SandySoilGenerationFeature::new);
	public static final RegistryObject<Feature<?>> SAVANNA_COARSE_DIRT_FEATURE = REGISTRY.register("savanna_coarse_dirt_feature", SavannaCoarseDirtFeatureFeature::new);
	public static final RegistryObject<Feature<?>> KAOLIN_SAVANNAH_BLOBS = REGISTRY.register("kaolin_savannah_blobs", KaolinSavannahBlobsFeature::new);
	public static final RegistryObject<Feature<?>> KAOLIN_SAVANNAH_ROCKS = REGISTRY.register("kaolin_savannah_rocks", KaolinSavannahRocksFeature::new);
	public static final RegistryObject<Feature<?>> SAVANNA_SCORCHED_DIRT_FEATURE = REGISTRY.register("savanna_scorched_dirt_feature", SavannaScorchedDirtFeatureFeature::new);
	public static final RegistryObject<Feature<?>> SILT_SOIL_FEATURE = REGISTRY.register("silt_soil_feature", SiltSoilFeatureFeature::new);
	public static final RegistryObject<Feature<?>> DIRTY_MUD_FEATURE = REGISTRY.register("dirty_mud_feature", DirtyMudFeatureFeature::new);
	public static final RegistryObject<Feature<?>> DRIED_MUD_FEATURE = REGISTRY.register("dried_mud_feature", DriedMudFeatureFeature::new);
	public static final RegistryObject<Feature<?>> QUARTZ_SAND_DISTRIBUTION = REGISTRY.register("quartz_sand_distribution", QuartzSandDistributionFeature::new);
	public static final RegistryObject<Feature<?>> HOT_SPRINGS_LIMESTONE_BLOBS = REGISTRY.register("hot_springs_limestone_blobs", HotSpringsLimestoneBlobsFeature::new);
	public static final RegistryObject<Feature<?>> HOT_SPRINGS_WATER_DELTAS = REGISTRY.register("hot_springs_water_deltas", HotSpringsWaterDeltasFeature::new);
	public static final RegistryObject<Feature<?>> HOT_SPRINGS_MAGMA = REGISTRY.register("hot_springs_magma", HotSpringsMagmaFeature::new);
	public static final RegistryObject<Feature<?>> HOT_SPRINGS_SEA_SALT = REGISTRY.register("hot_springs_sea_salt", HotSpringsSeaSaltFeature::new);
	public static final RegistryObject<Feature<?>> HOT_SPRINGS_CALCITE = REGISTRY.register("hot_springs_calcite", HotSpringsCalciteFeature::new);
	public static final RegistryObject<Feature<?>> HOT_SPRINGS_DRIPSTONE = REGISTRY.register("hot_springs_dripstone", HotSpringsDripstoneFeature::new);
	public static final RegistryObject<Feature<?>> HOT_SPRINGS_BASALT = REGISTRY.register("hot_springs_basalt", HotSpringsBasaltFeature::new);
	public static final RegistryObject<Feature<?>> AMBER_FOREST_ORANGE_MARBLE_ROCKS = REGISTRY.register("amber_forest_orange_marble_rocks", AmberForestOrangeMarbleRocksFeature::new);
	public static final RegistryObject<Feature<?>> AMBER_FOREST_ORANGE_SCHIST_ROCK = REGISTRY.register("amber_forest_orange_schist_rock", AmberForestOrangeSchistRockFeature::new);
	public static final RegistryObject<Feature<?>> AMBER_FOREST_SOAPSTONE_BLOBS = REGISTRY.register("amber_forest_soapstone_blobs", AmberForestSoapstoneBlobsFeature::new);
	public static final RegistryObject<Feature<?>> AMBER_FOREST_ORANGE_SCHIST_BLOBS = REGISTRY.register("amber_forest_orange_schist_blobs", AmberForestOrangeSchistBlobsFeature::new);
	public static final RegistryObject<Feature<?>> AMBER_FOREST_ADDITIONAL_LAPIS_ORE = REGISTRY.register("amber_forest_additional_lapis_ore", AmberForestAdditionalLapisOreFeature::new);
	public static final RegistryObject<Feature<?>> AMBER_FOREST_LEAF_CARPETS = REGISTRY.register("amber_forest_leaf_carpets", AmberForestLeafCarpetsFeature::new);
	public static final RegistryObject<Feature<?>> AMBER_SENTINEL_GENERATOR = REGISTRY.register("amber_sentinel_generator", AmberSentinelGeneratorFeature::new);
	public static final RegistryObject<Feature<?>> MOUNTAIN_LAUREL_GENERATOR = REGISTRY.register("mountain_laurel_generator", MountainLaurelGeneratorFeature::new);
	public static final RegistryObject<Feature<?>> LIGNITE_FLATS_DIRTY_MUD = REGISTRY.register("lignite_flats_dirty_mud", LigniteFlatsDirtyMudFeature::new);
	public static final RegistryObject<Feature<?>> NETHER_RUBY_DISTRIBUTION = REGISTRY.register("nether_ruby_distribution", NetherRubyDistributionFeature::new);
	public static final RegistryObject<Feature<?>> AMBER_FOREST_CITRINE_DISTRIBUTION = REGISTRY.register("amber_forest_citrine_distribution", AmberForestCitrineDistributionFeature::new);
	public static final RegistryObject<Feature<?>> PERMAFROST_KYANITE_DISTRIBUTION = REGISTRY.register("permafrost_kyanite_distribution", PermafrostKyaniteDistributionFeature::new);
	public static final RegistryObject<Feature<?>> PERMAFROST_PACKED_ICE_FEATURE = REGISTRY.register("permafrost_packed_ice_feature", PermafrostPackedIceFeatureFeature::new);
	public static final RegistryObject<Feature<?>> PERMAFROST_BLUE_ICE_FEATURE = REGISTRY.register("permafrost_blue_ice_feature", PermafrostBlueIceFeatureFeature::new);
	public static final RegistryObject<Feature<?>> PERMAFROST_SNOW_SURFACE_FEATURE = REGISTRY.register("permafrost_snow_surface_feature", PermafrostSnowSurfaceFeatureFeature::new);
	public static final RegistryObject<Feature<?>> PERMAFROST_BLACK_ICE_FEATURE = REGISTRY.register("permafrost_black_ice_feature", PermafrostBlackIceFeatureFeature::new);
	public static final RegistryObject<Feature<?>> PERMAFROST_ROCK_FEATURE = REGISTRY.register("permafrost_rock_feature", PermafrostRockFeatureFeature::new);
	public static final RegistryObject<Feature<?>> PERMAFROST_ICE_CLIFFS = REGISTRY.register("permafrost_ice_cliffs", PermafrostIceCliffsFeature::new);
	public static final RegistryObject<Feature<?>> PERMAFROST_ICY_SNOW_MOUNTAIN_COVERAGE = REGISTRY.register("permafrost_icy_snow_mountain_coverage", PermafrostIcySnowMountainCoverageFeature::new);
}
