...
import net.centertain.cemm.client.gui.JournalPage29FinalScreen;
...
public class CemmModScreens {
	...
	public static void clientLoad(FMLClientSetupEvent event) {
		event.enqueueWork(() -> {
			...
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_29_FINAL.get(), JournalPage29FinalScreen::new);
		});
	}
}
