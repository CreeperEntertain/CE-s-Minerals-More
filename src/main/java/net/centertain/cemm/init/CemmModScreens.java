...
import net.centertain.cemm.client.gui.WoodenCrateInterfaceScreen;
import net.centertain.cemm.client.gui.VacuumizerInterfaceScreen;
import net.centertain.cemm.client.gui.RopeBoxInterfaceScreen;
import net.centertain.cemm.client.gui.RefineryInterfaceScreen;
import net.centertain.cemm.client.gui.PurifierRecipeInterfaceScreen;
...
import net.centertain.cemm.client.gui.BlockRefineryRecipeInterfaceScreen;
import net.centertain.cemm.client.gui.BlockRefineryInterfaceScreen;
...
public class CemmModScreens {
	...
	public static void clientLoad(FMLClientSetupEvent event) {
		event.enqueueWork(() -> {
			...
			MenuScreens.register(CemmModMenus.JOURNAL_MAIN.get(), JournalMainScreen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PREFACE_1.get(), JournalPreface1Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PREFACE_2.get(), JournalPreface2Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_01.get(), JournalPage01Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_02.get(), JournalPage02Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_03.get(), JournalPage03Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_04.get(), JournalPage04Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_05.get(), JournalPage05Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_06.get(), JournalPage06Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_07.get(), JournalPage07Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_08.get(), JournalPage08Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_09.get(), JournalPage09Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_10.get(), JournalPage10Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_11.get(), JournalPage11Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_12.get(), JournalPage12Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_13.get(), JournalPage13Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_14.get(), JournalPage14Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_15.get(), JournalPage15Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_16.get(), JournalPage16Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_17.get(), JournalPage17Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_18.get(), JournalPage18Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_19.get(), JournalPage19Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_20.get(), JournalPage20Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_21.get(), JournalPage21Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_22.get(), JournalPage22Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_23.get(), JournalPage23Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_24.get(), JournalPage24Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_25.get(), JournalPage25Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_26.get(), JournalPage26Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_27.get(), JournalPage27Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_28.get(), JournalPage28Screen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_FINAL.get(), JournalPageFinalScreen::new);
			MenuScreens.register(CemmModMenus.JOURNAL_PAGE_29.get(), JournalPage29Screen::new);
			MenuScreens.register(CemmModMenus.ORE_DISPLAY_GUI.get(), OreDisplayGUIScreen::new);
			MenuScreens.register(CemmModMenus.WOODEN_CRATE_INTERFACE.get(), WoodenCrateInterfaceScreen::new);
			MenuScreens.register(CemmModMenus.BLOCK_REFINERY_INTERFACE.get(), BlockRefineryInterfaceScreen::new);
			MenuScreens.register(CemmModMenus.BLOCK_REFINERY_RECIPE_INTERFACE.get(), BlockRefineryRecipeInterfaceScreen::new);
			MenuScreens.register(CemmModMenus.PURIFIER_RECIPE_INTERFACE.get(), PurifierRecipeInterfaceScreen::new);
			MenuScreens.register(CemmModMenus.ROPE_BOX_INTERFACE.get(), RopeBoxInterfaceScreen::new);
			MenuScreens.register(CemmModMenus.PARCHMENT_MAIN.get(), ParchmentMainScreen::new);
		});
	}
}
