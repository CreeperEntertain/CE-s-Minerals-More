...
import net.centertain.cemm.client.particle.EmberParticleParticle;
...
public class CemmModParticles {
	...
	public static void registerParticles(RegisterParticleProvidersEvent event) {
		...
		event.registerSpriteSet(CemmModParticleTypes.EMBER_PARTICLE.get(), EmberParticleParticle::provider);
	}
}
