...
import net.centertain.cemm.procedures.Journal19Procedure;
...
public class JournalPage18ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage18ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage18ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage18ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage18ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage18Menu.guistate;
		// security measure to prevent arbitrary chunk generation
		if (!world.hasChunkAt(new BlockPos(x, y, z)))
			return;
		if (buttonID == 0) {

			Journal19Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 1) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage18ButtonMessage.class, JournalPage18ButtonMessage::buffer, JournalPage18ButtonMessage::new, JournalPage18ButtonMessage::handler);
	}
}
