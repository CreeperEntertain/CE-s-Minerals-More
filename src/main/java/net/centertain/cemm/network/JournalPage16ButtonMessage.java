...
import net.centertain.cemm.procedures.Journal15Procedure;
...
public class JournalPage16ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage16ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage16ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage16ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage16ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage16Menu.guistate;
		...
		if (buttonID == 1) {
			...
			Journal15Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 2) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage16ButtonMessage.class, JournalPage16ButtonMessage::buffer, JournalPage16ButtonMessage::new, JournalPage16ButtonMessage::handler);
	}
}
