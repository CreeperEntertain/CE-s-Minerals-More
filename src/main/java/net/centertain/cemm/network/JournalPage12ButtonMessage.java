...
public class JournalPage12ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage12ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage12ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage12ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage12ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage12Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage12ButtonMessage.class, JournalPage12ButtonMessage::buffer, JournalPage12ButtonMessage::new, JournalPage12ButtonMessage::handler);
	}
}
