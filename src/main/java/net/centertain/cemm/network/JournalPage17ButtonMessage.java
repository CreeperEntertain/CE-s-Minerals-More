...
import net.centertain.cemm.procedures.Journal18Procedure;
import net.centertain.cemm.procedures.Journal17Procedure;
import net.centertain.cemm.procedures.Journal16Procedure;
...
public class JournalPage17ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage17ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage17ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage17ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage17ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage17Menu.guistate;
		// security measure to prevent arbitrary chunk generation
		if (!world.hasChunkAt(new BlockPos(x, y, z)))
			return;
		if (buttonID == 0) {

			Journal18Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 1) {

			Journal16Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 2) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage17ButtonMessage.class, JournalPage17ButtonMessage::buffer, JournalPage17ButtonMessage::new, JournalPage17ButtonMessage::handler);
	}
}
