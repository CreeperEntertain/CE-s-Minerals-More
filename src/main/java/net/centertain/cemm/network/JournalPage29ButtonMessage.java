...
public class JournalPage29ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage29ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage29ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage29ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage29ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage29Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage29ButtonMessage.class, JournalPage29ButtonMessage::buffer, JournalPage29ButtonMessage::new, JournalPage29ButtonMessage::handler);
	}
}
