...
import net.centertain.cemm.procedures.JournalPreface02Procedure;
...
public class JournalPreface1ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPreface1ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPreface1ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPreface1ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPreface1ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPreface1Menu.guistate;
		// security measure to prevent arbitrary chunk generation
		if (!world.hasChunkAt(new BlockPos(x, y, z)))
			return;
		if (buttonID == 0) {

			JournalPreface02Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 1) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPreface1ButtonMessage.class, JournalPreface1ButtonMessage::buffer, JournalPreface1ButtonMessage::new, JournalPreface1ButtonMessage::handler);
	}
}
