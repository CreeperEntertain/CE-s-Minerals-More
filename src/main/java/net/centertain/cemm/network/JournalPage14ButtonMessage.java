...
public class JournalPage14ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage14ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage14ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage14ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage14ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage14Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage14ButtonMessage.class, JournalPage14ButtonMessage::buffer, JournalPage14ButtonMessage::new, JournalPage14ButtonMessage::handler);
	}
}
