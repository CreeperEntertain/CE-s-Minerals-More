...
public class JournalPage06ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage06ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage06ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage06ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage06ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage06Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage06ButtonMessage.class, JournalPage06ButtonMessage::buffer, JournalPage06ButtonMessage::new, JournalPage06ButtonMessage::handler);
	}
}
