...
public class JournalPage27ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage27ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage27ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage27ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage27ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage27Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage27ButtonMessage.class, JournalPage27ButtonMessage::buffer, JournalPage27ButtonMessage::new, JournalPage27ButtonMessage::handler);
	}
}
