...
public class JournalPage20ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage20ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage20ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage20ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage20ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage20Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage20ButtonMessage.class, JournalPage20ButtonMessage::buffer, JournalPage20ButtonMessage::new, JournalPage20ButtonMessage::handler);
	}
}
