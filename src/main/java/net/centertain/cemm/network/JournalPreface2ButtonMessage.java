...
public class JournalPreface2ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPreface2ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPreface2ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPreface2ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPreface2ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPreface2Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPreface2ButtonMessage.class, JournalPreface2ButtonMessage::buffer, JournalPreface2ButtonMessage::new, JournalPreface2ButtonMessage::handler);
	}
}
