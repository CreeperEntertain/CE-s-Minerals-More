...
public class JournalPage01ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage01ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage01ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage01ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage01ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage01Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage01ButtonMessage.class, JournalPage01ButtonMessage::buffer, JournalPage01ButtonMessage::new, JournalPage01ButtonMessage::handler);
	}
}
