...
public class JournalPage15ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage15ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage15ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage15ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage15ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage15Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage15ButtonMessage.class, JournalPage15ButtonMessage::buffer, JournalPage15ButtonMessage::new, JournalPage15ButtonMessage::handler);
	}
}
