...
public class JournalPage05ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage05ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage05ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage05ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage05ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage05Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage05ButtonMessage.class, JournalPage05ButtonMessage::buffer, JournalPage05ButtonMessage::new, JournalPage05ButtonMessage::handler);
	}
}
