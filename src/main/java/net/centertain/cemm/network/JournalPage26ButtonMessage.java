...
public class JournalPage26ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage26ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage26ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage26ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage26ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage26Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage26ButtonMessage.class, JournalPage26ButtonMessage::buffer, JournalPage26ButtonMessage::new, JournalPage26ButtonMessage::handler);
	}
}
