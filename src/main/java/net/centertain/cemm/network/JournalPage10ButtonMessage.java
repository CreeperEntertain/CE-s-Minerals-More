...
import net.centertain.cemm.procedures.Journal11Procedure;
import net.centertain.cemm.procedures.Journal10Procedure;
import net.centertain.cemm.procedures.Journal09Procedure;
...
public class JournalPage10ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage10ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage10ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage10ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage10ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage10Menu.guistate;
		// security measure to prevent arbitrary chunk generation
		if (!world.hasChunkAt(new BlockPos(x, y, z)))
			return;
		if (buttonID == 0) {

			Journal11Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 1) {

			Journal09Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 2) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage10ButtonMessage.class, JournalPage10ButtonMessage::buffer, JournalPage10ButtonMessage::new, JournalPage10ButtonMessage::handler);
	}
}
