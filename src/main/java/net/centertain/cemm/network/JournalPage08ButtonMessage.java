...
public class JournalPage08ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage08ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage08ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage08ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage08ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage08Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage08ButtonMessage.class, JournalPage08ButtonMessage::buffer, JournalPage08ButtonMessage::new, JournalPage08ButtonMessage::handler);
	}
}
