...
import net.centertain.cemm.procedures.Journal05Procedure;
import net.centertain.cemm.procedures.Journal04Procedure;
import net.centertain.cemm.procedures.Journal03Procedure;
...
public class JournalPage04ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage04ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage04ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage04ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage04ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage04Menu.guistate;
		// security measure to prevent arbitrary chunk generation
		if (!world.hasChunkAt(new BlockPos(x, y, z)))
			return;
		if (buttonID == 0) {

			Journal05Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 1) {

			Journal03Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 2) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage04ButtonMessage.class, JournalPage04ButtonMessage::buffer, JournalPage04ButtonMessage::new, JournalPage04ButtonMessage::handler);
	}
}
