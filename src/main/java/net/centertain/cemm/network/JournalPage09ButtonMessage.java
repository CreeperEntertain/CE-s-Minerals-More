...
public class JournalPage09ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage09ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage09ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage09ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage09ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage09Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage09ButtonMessage.class, JournalPage09ButtonMessage::buffer, JournalPage09ButtonMessage::new, JournalPage09ButtonMessage::handler);
	}
}
