...
public class JournalPage11ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage11ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage11ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage11ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage11ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage11Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage11ButtonMessage.class, JournalPage11ButtonMessage::buffer, JournalPage11ButtonMessage::new, JournalPage11ButtonMessage::handler);
	}
}
