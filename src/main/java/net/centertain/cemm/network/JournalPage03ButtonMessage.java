...
import net.centertain.cemm.procedures.Journal02Procedure;
...
public class JournalPage03ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage03ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage03ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage03ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage03ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage03Menu.guistate;
		...
		if (buttonID == 1) {
			...
			Journal02Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 2) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage03ButtonMessage.class, JournalPage03ButtonMessage::buffer, JournalPage03ButtonMessage::new, JournalPage03ButtonMessage::handler);
	}
}
