...
public class JournalPage23ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage23ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage23ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage23ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage23ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage23Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage23ButtonMessage.class, JournalPage23ButtonMessage::buffer, JournalPage23ButtonMessage::new, JournalPage23ButtonMessage::handler);
	}
}
