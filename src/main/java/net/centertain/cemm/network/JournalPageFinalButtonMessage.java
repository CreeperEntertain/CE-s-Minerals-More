...
public class JournalPageFinalButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPageFinalButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPageFinalButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPageFinalButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPageFinalButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPageFinalMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPageFinalButtonMessage.class, JournalPageFinalButtonMessage::buffer, JournalPageFinalButtonMessage::new, JournalPageFinalButtonMessage::handler);
	}
}
