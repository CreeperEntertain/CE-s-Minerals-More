...
public class JournalPage02ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage02ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage02ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage02ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage02ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage02Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage02ButtonMessage.class, JournalPage02ButtonMessage::buffer, JournalPage02ButtonMessage::new, JournalPage02ButtonMessage::handler);
	}
}
