...
public class JournalPage24ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage24ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage24ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage24ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage24ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage24Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage24ButtonMessage.class, JournalPage24ButtonMessage::buffer, JournalPage24ButtonMessage::new, JournalPage24ButtonMessage::handler);
	}
}
