...
public class JournalPage19ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage19ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage19ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage19ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage19ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage19Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage19ButtonMessage.class, JournalPage19ButtonMessage::buffer, JournalPage19ButtonMessage::new, JournalPage19ButtonMessage::handler);
	}
}
