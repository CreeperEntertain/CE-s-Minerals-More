...
import net.centertain.cemm.procedures.Journal08Procedure;
import net.centertain.cemm.procedures.Journal07Procedure;
import net.centertain.cemm.procedures.Journal06Procedure;
...
public class JournalPage07ButtonMessage {
	private final int buttonID, x, y, z;

	public JournalPage07ButtonMessage(FriendlyByteBuf buffer) {
	...
	public JournalPage07ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JournalPage07ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JournalPage07ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = JournalPage07Menu.guistate;
		// security measure to prevent arbitrary chunk generation
		if (!world.hasChunkAt(new BlockPos(x, y, z)))
			return;
		if (buttonID == 0) {

			Journal08Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 1) {

			Journal06Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 2) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CemmMod.addNetworkMessage(JournalPage07ButtonMessage.class, JournalPage07ButtonMessage::buffer, JournalPage07ButtonMessage::new, JournalPage07ButtonMessage::handler);
	}
}
