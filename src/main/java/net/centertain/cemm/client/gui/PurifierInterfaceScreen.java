...
public class PurifierInterfaceScreen extends AbstractContainerScreen<PurifierInterfaceMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/arrow.png"), this.leftPos + 35, this.topPos + 19, 0, 0, 68, 12, 68, 12);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.cemm.purifier_interface.label_empty"), 6, 6, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.cemm.purifier_interface.label_inventory"), 6, 41, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.cemm.purifier_interface.label_output"), 114, 6, -12829636, false);
	}
