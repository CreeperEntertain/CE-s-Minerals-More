...
public class ElectrolyzerInterfaceScreen extends AbstractContainerScreen<ElectrolyzerInterfaceMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.cemm.electrolyzer_interface.label_energy_level_energy"), 7, 8, -12829636);
		this.font.draw(poseStack,

				BatteryEnergyValueProcedure.execute(world, entity), 113, 35, -16751104);
		this.font.draw(poseStack, Component.translatable("gui.cemm.electrolyzer_interface.label_mobile_battery"), 7, 35, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.cemm.electrolyzer_interface.label_main_product"), 104, 59, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.cemm.electrolyzer_interface.label_side_product"), 104, 106, -12829636);
		this.font.draw(poseStack,
