...
public class PurifierRecipeInterfaceScreen extends AbstractContainerScreen<PurifierRecipeInterfaceMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/vertical_line_16.png"), this.leftPos + 180, this.topPos + 139, 0, 0, 1, 16, 1, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/raw_medicine.png"), this.leftPos + 189, this.topPos + 139, 0, 0, 16, 16, 16, 16);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, Component.translatable("gui.cemm.purifier_recipe_interface.label_129"), 207, 148, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.cemm.purifier_recipe_interface.label_130"), 162, 148, -1, false);
	}
