...
public class GoalsMainScreen extends AbstractContainerScreen<GoalsMainMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		goalsetter.render(ms, mouseX, mouseY, partialTicks);
	}
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		if (GoalElementDisplayCheck1Procedure.execute(entity))
			this.font.draw(poseStack,
					...
					GoalCheckText1Procedure.execute(entity), 62, 42, -1);
		if (GoalElementDisplayCheck2Procedure.execute(entity))
			this.font.draw(poseStack,

					GoalCheckText2Procedure.execute(entity), 62, 62, -1);
		if (GoalElementDisplayCheck3Procedure.execute(entity))
			this.font.draw(poseStack,

					GoalCheckText3Procedure.execute(entity), 62, 82, -1);
		if (GoalElementDisplayCheck4Procedure.execute(entity))
			this.font.draw(poseStack,

					GoalCheckText4Procedure.execute(entity), 62, 102, -1);
		if (GoalElementDisplayCheck5Procedure.execute(entity))
			this.font.draw(poseStack,

					GoalCheckText5Procedure.execute(entity), 62, 122, -1);
		if (GoalElementDisplayCheck6Procedure.execute(entity))
			this.font.draw(poseStack,

					GoalCheckText6Procedure.execute(entity), 62, 142, -1);
		if (GoalElementDisplayCheck7Procedure.execute(entity))
			this.font.draw(poseStack,

					GoalCheckText7Procedure.execute(entity), 62, 162, -1);
		if (GoalElementDisplayCheck8Procedure.execute(entity))
			this.font.draw(poseStack,

					GoalCheckText8Procedure.execute(entity), 62, 182, -1);
		if (GoalElementDisplayCheck9Procedure.execute(entity))
			this.font.draw(poseStack,

					GoalCheckText9Procedure.execute(entity), 62, 202, -1);
		if (GoalElementDisplayCheck10Procedure.execute(entity))
			this.font.draw(poseStack,

					GoalCheckText10Procedure.execute(entity), 62, 222, -1);
	}
	...
	public void init() {
		...
		button_add = new Button(this.leftPos + 260, this.topPos + 8, 40, 20, Component.translatable("gui.cemm.goals_main.button_add"), e -> {
		...
		button_remove = new Button(this.leftPos + 2, this.topPos + 37, 56, 20, Component.translatable("gui.cemm.goals_main.button_remove"), e -> {
			if (GoalElementDisplayCheck1Procedure.execute(entity)) {
		...
		button_remove1 = new Button(this.leftPos + 2, this.topPos + 57, 56, 20, Component.translatable("gui.cemm.goals_main.button_remove1"), e -> {
			if (GoalElementDisplayCheck2Procedure.execute(entity)) {
		...
		button_remove2 = new Button(this.leftPos + 2, this.topPos + 77, 56, 20, Component.translatable("gui.cemm.goals_main.button_remove2"), e -> {
			if (GoalElementDisplayCheck3Procedure.execute(entity)) {
		...
		button_remove3 = new Button(this.leftPos + 2, this.topPos + 97, 56, 20, Component.translatable("gui.cemm.goals_main.button_remove3"), e -> {
			if (GoalElementDisplayCheck4Procedure.execute(entity)) {
		...
		button_remove4 = new Button(this.leftPos + 2, this.topPos + 117, 56, 20, Component.translatable("gui.cemm.goals_main.button_remove4"), e -> {
			if (GoalElementDisplayCheck5Procedure.execute(entity)) {
		...
		button_remove5 = new Button(this.leftPos + 2, this.topPos + 137, 56, 20, Component.translatable("gui.cemm.goals_main.button_remove5"), e -> {
			if (GoalElementDisplayCheck6Procedure.execute(entity)) {
		...
		button_remove6 = new Button(this.leftPos + 2, this.topPos + 157, 56, 20, Component.translatable("gui.cemm.goals_main.button_remove6"), e -> {
			if (GoalElementDisplayCheck7Procedure.execute(entity)) {
		...
		button_remove7 = new Button(this.leftPos + 2, this.topPos + 177, 56, 20, Component.translatable("gui.cemm.goals_main.button_remove7"), e -> {
			if (GoalElementDisplayCheck8Procedure.execute(entity)) {
		...
		button_remove8 = new Button(this.leftPos + 2, this.topPos + 197, 56, 20, Component.translatable("gui.cemm.goals_main.button_remove8"), e -> {
			if (GoalElementDisplayCheck9Procedure.execute(entity)) {
		...
		button_remove9 = new Button(this.leftPos + 2, this.topPos + 217, 56, 20, Component.translatable("gui.cemm.goals_main.button_remove9"), e -> {
			if (GoalElementDisplayCheck10Procedure.execute(entity)) {
