...
public class GoalsMainScreen extends AbstractContainerScreen<GoalsMainMenu> {
	...
	public void init() {
		super.init();
		goalsetter = new EditBox(this.font, this.leftPos + 125, this.topPos + 9, 118, 18, Component.translatable("gui.cemm.goals_main.goalsetter")) {
			@Override
		...
		goalsetter.setSuggestion(Component.translatable("gui.cemm.goals_main.goalsetter").getString());
