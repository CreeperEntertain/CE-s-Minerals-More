...
public class InstructionsMiningSelectionScreen extends AbstractContainerScreen<InstructionsMiningSelectionMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_antimony.png"), this.leftPos + 333, this.topPos + 120, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_arsenic.png"), this.leftPos + 53, this.topPos + 8, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_baryte.png"), this.leftPos + 93, this.topPos + 8, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_bastnaesite.png"), this.leftPos + 93, this.topPos + 120, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_bauxite.png"), this.leftPos + 13, this.topPos + 8, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_beryl.png"), this.leftPos + 133, this.topPos + 8, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_bismuth.png"), this.leftPos + 173, this.topPos + 8, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_cassiterite.png"), this.leftPos + 53, this.topPos + 176, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_cesium.png"), this.leftPos + 93, this.topPos + 64, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_chlorophyl.png"), this.leftPos + 213, this.topPos + 8, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_chrome.png"), this.leftPos + 53, this.topPos + 64, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_cinnabar.png"), this.leftPos + 253, this.topPos + 176, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_cobalt.png"), this.leftPos + 13, this.topPos + 64, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_columbite.png"), this.leftPos + 53, this.topPos + 120, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_dolomite.png"), this.leftPos + 373, this.topPos + 64, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_fluorite.png"), this.leftPos + 373, this.topPos + 8, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_graphite.png"), this.leftPos + 253, this.topPos + 8, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_iridosmine.png"), this.leftPos + 133, this.topPos + 120, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_lignite.png"), this.leftPos + 293, this.topPos + 8, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_limestone.png"), this.leftPos + 333, this.topPos + 8, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_magnetite.png"), this.leftPos + 173, this.topPos + 64, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_malachite.png"), this.leftPos + 133, this.topPos + 64, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_minium.png"), this.leftPos + 213, this.topPos + 120, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_misery_drops.png"), this.leftPos + 333, this.topPos + 64, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_monazite.png"), this.leftPos + 253, this.topPos + 64, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_mountain_quartz.png"), this.leftPos + 373, this.topPos + 120, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_niter.png"), this.leftPos + 213, this.topPos + 64, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_platinum.png"), this.leftPos + 253, this.topPos + 120, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_polymorous.png"), this.leftPos + 173, this.topPos + 120, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_pyrolusite.png"), this.leftPos + 13, this.topPos + 120, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_smokey_quartz.png"), this.leftPos + 13, this.topPos + 176, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_spodumene.png"), this.leftPos + 293, this.topPos + 64, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_sulfur.png"), this.leftPos + 293, this.topPos + 120, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_vanadinite.png"), this.leftPos + 93, this.topPos + 176, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_wolframite.png"), this.leftPos + 133, this.topPos + 176, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_xenotime.png"), this.leftPos + 173, this.topPos + 176, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_ytterbium.png"), this.leftPos + 213, this.topPos + 176, 0, 0, 36, 52, 36, 52);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/card_zircon.png"), this.leftPos + 293, this.topPos + 176, 0, 0, 36, 52, 36, 52);
