...
public class InstructionsVacuumizingScreen extends AbstractContainerScreen<InstructionsVacuumizingMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/vacuumizer.png"), this.leftPos + 170, this.topPos + 8, 0, 0, 18, 18, 18, 18);

		if (DisplayCesiumPelletProcedure.execute(entity)) {
			guiGraphics.blit(new ResourceLocation("cemm:textures/screens/recipe_cesium_pellet.png"), this.leftPos + 195, this.topPos + 53, 0, 0, 176, 96, 176, 96);
		}
		if (DisplayEuropiumPelletProcedure.execute(entity)) {
			guiGraphics.blit(new ResourceLocation("cemm:textures/screens/recipe_europium_pellet.png"), this.leftPos + 195, this.topPos + 53, 0, 0, 176, 96, 176, 96);
		}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.cemm.instructions_vacuumizing.label_vacuumizer"), 189, 12, -1, false);
	}
