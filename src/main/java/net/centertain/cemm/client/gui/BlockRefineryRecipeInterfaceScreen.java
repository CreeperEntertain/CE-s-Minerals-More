...
public class BlockRefineryRecipeInterfaceScreen extends AbstractContainerScreen<BlockRefineryRecipeInterfaceMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/vertical_line_16.png"), this.leftPos + 63, this.topPos + 13, 0, 0, 1, 16, 1, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/vertical_line_16.png"), this.leftPos + 63, this.topPos + 31, 0, 0, 1, 16, 1, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/vertical_line_16.png"), this.leftPos + 63, this.topPos + 49, 0, 0, 1, 16, 1, 16);
		...
		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/vertical_line_16.png"), this.leftPos + 99, this.topPos + 67, 0, 0, 1, 16, 1, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/stick.png"), this.leftPos + 72, this.topPos + 67, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/polished_wattle_preview.png"), this.leftPos + 45, this.topPos + 67, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/sanded_wattle_preview.png"), this.leftPos + 36, this.topPos + 67, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/smooth_wattle_preview.png"), this.leftPos + 27, this.topPos + 67, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/wattle_preview.png"), this.leftPos + 18, this.topPos + 67, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_wattle_square_preview.png"), this.leftPos + 108, this.topPos + 67, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_wattle_vertial_square_preview.png"), this.leftPos + 126, this.topPos + 67, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_wattle_vertical_corners_preview.png"), this.leftPos + 144, this.topPos + 67, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_wattle_corners_preview.png"), this.leftPos + 162, this.topPos + 67, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_wattle_wheel_preview.png"), this.leftPos + 180, this.topPos + 67, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_wattle_latin_preview.png"), this.leftPos + 198, this.topPos + 67, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_wattle_saltire_preview.png"), this.leftPos + 216, this.topPos + 67, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_wattle_square_horizontal_preview.png"), this.leftPos + 234, this.topPos + 67, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_wattle_square_vertical_preview.png"), this.leftPos + 252, this.topPos + 67, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_wattle_square_latin_preview.png"), this.leftPos + 306, this.topPos + 67, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_wattle_square_saltire_preview.png"), this.leftPos + 324, this.topPos + 67, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_wattle_square_falling_preview.png"), this.leftPos + 270, this.topPos + 67, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_wattle_square_rising_preview.png"), this.leftPos + 288, this.topPos + 67, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/smooth_kaolin_preview.png"), this.leftPos + 18, this.topPos + 85, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/stick.png"), this.leftPos + 36, this.topPos + 85, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/vertical_line_16.png"), this.leftPos + 63, this.topPos + 85, 0, 0, 1, 16, 1, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_kaolin_square_preview.png"), this.leftPos + 72, this.topPos + 85, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_kaolin_vertial_square_preview.png"), this.leftPos + 90, this.topPos + 85, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_kaolin_vertical_corners_preview.png"), this.leftPos + 108, this.topPos + 85, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_kaolin_corners_preview.png"), this.leftPos + 126, this.topPos + 85, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_kaolin_wheel_preview.png"), this.leftPos + 144, this.topPos + 85, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_kaolin_latin_preview.png"), this.leftPos + 162, this.topPos + 85, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_kaolin_saltire_preview.png"), this.leftPos + 180, this.topPos + 85, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_kaolin_square_horizontal_preview.png"), this.leftPos + 198, this.topPos + 85, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_kaolin_square_vertical_preview.png"), this.leftPos + 216, this.topPos + 85, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_kaolin_square_falling_preview.png"), this.leftPos + 234, this.topPos + 85, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_kaolin_square_rising_preview.png"), this.leftPos + 252, this.topPos + 85, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_kaolin_square_latin_preview.png"), this.leftPos + 270, this.topPos + 85, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/framed_kaolin_square_saltire_preview.png"), this.leftPos + 288, this.topPos + 85, 0, 0, 16, 16, 16, 16);
