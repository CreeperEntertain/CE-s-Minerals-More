...
public class InstructionsMainScreen extends AbstractContainerScreen<InstructionsMainMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/text_electrolyzer.png"), this.leftPos + 13, this.topPos + 79, 0, 0, 132, 16, 132, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/text_pressurizer.png"), this.leftPos + 284, this.topPos + 79, 0, 0, 127, 16, 127, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/text_refinery.png"), this.leftPos + 57, this.topPos + 146, 0, 0, 88, 16, 88, 16);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/text_vacuumizer.png"), this.leftPos + 284, this.topPos + 146, 0, 0, 115, 16, 115, 16);
	...
	public void init() {
		...
		imagebutton_button_where_to_mine = new ImageButton(this.leftPos + 242, this.topPos + 206, 184, 32, 0, 0, 32, new ResourceLocation("cemm:textures/screens/atlas/imagebutton_button_where_to_mine.png"), 184, 64, e -> {
			if (true) {
		...
		imagebutton_button_journal = new ImageButton(this.leftPos + 3, this.topPos + 206, 184, 32, 0, 0, 32, new ResourceLocation("cemm:textures/screens/atlas/imagebutton_button_journal.png"), 184, 64, e -> {
			if (true) {
