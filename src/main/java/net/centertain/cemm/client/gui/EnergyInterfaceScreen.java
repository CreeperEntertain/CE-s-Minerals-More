...
public class EnergyInterfaceScreen extends AbstractContainerScreen<EnergyInterfaceMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		this.blit(ms, this.leftPos + 7, this.topPos + 20, 0, 0, 182, 5, 182, 5);
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.cemm.energy_interface.label_energy_level_energy"), 7, 7, -12829636);
		this.font.draw(poseStack,

				BatteryEnergyValueProcedure.execute(world, entity), 113, 49, -16751104);
		this.font.draw(poseStack, Component.translatable("gui.cemm.energy_interface.label_mobile_battery"), 7, 49, -12829636);
		this.font.draw(poseStack,

				EnergyValueProcedure.execute(world, entity), 79, 7, -12829636);
	}
