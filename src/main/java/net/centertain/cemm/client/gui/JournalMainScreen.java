...
public class JournalMainScreen extends AbstractContainerScreen<JournalMainMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/journal_background_cover.png"), this.leftPos + 136, this.topPos + 0, 0, 0, 146, 180, 146, 180);

		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/journal_00_cover.png"), this.leftPos + 136, this.topPos + 0, 0, 0, 146, 180, 146, 180);
