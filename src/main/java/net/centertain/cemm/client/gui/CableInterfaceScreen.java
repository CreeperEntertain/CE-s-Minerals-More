...
public class CableInterfaceScreen extends AbstractContainerScreen<CableInterfaceMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		this.blit(ms, this.leftPos + 7, this.topPos + 24, 0, 0, 182, 5, 182, 5);
		...
		this.blit(ms, this.leftPos + 6, this.topPos + 24, 0, 0, 182, 5, 182, 5);
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.cemm.cable_interface.label_energy_level_energy"), 7, 8, -12829636);
