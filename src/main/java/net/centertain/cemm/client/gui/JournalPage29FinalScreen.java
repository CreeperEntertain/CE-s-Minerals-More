...
import net.centertain.cemm.network.JournalPage29FinalButtonMessage;
...
public class JournalPage29FinalScreen extends AbstractContainerScreen<JournalPage29FinalMenu> {
	private final static HashMap<String, Object> guistate = JournalPage29FinalMenu.guistate;
	...
	public JournalPage29FinalScreen(JournalPage29FinalMenu container, Inventory inventory, Component text) {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/journal_29_final.png"), this.leftPos + 136, this.topPos + 0, 0, 0, 146, 180, 146, 180);
	...
	public void init() {
		...
		imagebutton_journal_page_right = new ImageButton(this.leftPos + 236, this.topPos + 189, 46, 21, 0, 0, 21, new ResourceLocation("cemm:textures/screens/atlas/imagebutton_journal_page_right.png"), 46, 42, e -> {
			if (true) {
				CemmMod.PACKET_HANDLER.sendToServer(new JournalPage29FinalButtonMessage(0, x, y, z));
				JournalPage29FinalButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_journal_page_left = new ImageButton(this.leftPos + 136, this.topPos + 189, 46, 21, 0, 0, 21, new ResourceLocation("cemm:textures/screens/atlas/imagebutton_journal_page_left.png"), 46, 42, e -> {
			if (true) {
				CemmMod.PACKET_HANDLER.sendToServer(new JournalPage29FinalButtonMessage(1, x, y, z));
				JournalPage29FinalButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_back = new ImageButton(this.leftPos + 380, this.topPos + 182, 32, 32, 0, 0, 32, new ResourceLocation("cemm:textures/screens/atlas/imagebutton_back.png"), 32, 64, e -> {
			if (true) {
				CemmMod.PACKET_HANDLER.sendToServer(new JournalPage29FinalButtonMessage(2, x, y, z));
				JournalPage29FinalButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
		...
		imagebutton_journal_pressurizer_band = new ImageButton(this.leftPos + 8, this.topPos + 11, 128, 24, 0, 0, 24, new ResourceLocation("cemm:textures/screens/atlas/imagebutton_journal_pressurizer_band.png"), 128, 48, e -> {
			if (true) {
				CemmMod.PACKET_HANDLER.sendToServer(new JournalPage29FinalButtonMessage(3, x, y, z));
				JournalPage29FinalButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		});
		...
		imagebutton_journal_refinery_band = new ImageButton(this.leftPos + 8, this.topPos + 37, 128, 24, 0, 0, 24, new ResourceLocation("cemm:textures/screens/atlas/imagebutton_journal_refinery_band.png"), 128, 48, e -> {
			if (true) {
				CemmMod.PACKET_HANDLER.sendToServer(new JournalPage29FinalButtonMessage(4, x, y, z));
				JournalPage29FinalButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		});
		...
		imagebutton_journal_electrolyzer_band = new ImageButton(this.leftPos + 8, this.topPos + 63, 128, 24, 0, 0, 24, new ResourceLocation("cemm:textures/screens/atlas/imagebutton_journal_electrolyzer_band.png"), 128, 48, e -> {
			if (true) {
				CemmMod.PACKET_HANDLER.sendToServer(new JournalPage29FinalButtonMessage(5, x, y, z));
				JournalPage29FinalButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		});
		...
		imagebutton_journal_vacuumizer_band = new ImageButton(this.leftPos + 8, this.topPos + 89, 128, 24, 0, 0, 24, new ResourceLocation("cemm:textures/screens/atlas/imagebutton_journal_vacuumizer_band.png"), 128, 48, e -> {
			if (true) {
				CemmMod.PACKET_HANDLER.sendToServer(new JournalPage29FinalButtonMessage(6, x, y, z));
				JournalPage29FinalButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		});
		...
		imagebutton_journal_xanthanium_band = new ImageButton(this.leftPos + 282, this.topPos + 145, 128, 24, 0, 0, 24, new ResourceLocation("cemm:textures/screens/atlas/imagebutton_journal_xanthanium_band.png"), 128, 48, e -> {
			if (true) {
				CemmMod.PACKET_HANDLER.sendToServer(new JournalPage29FinalButtonMessage(7, x, y, z));
				JournalPage29FinalButtonMessage.handleButtonAction(entity, 7, x, y, z);
			}
		});
		...
		imagebutton_journal_chlorophyl_band = new ImageButton(this.leftPos + 282, this.topPos + 119, 128, 24, 0, 0, 24, new ResourceLocation("cemm:textures/screens/atlas/imagebutton_journal_chlorophyl_band.png"), 128, 48, e -> {
			if (true) {
				CemmMod.PACKET_HANDLER.sendToServer(new JournalPage29FinalButtonMessage(8, x, y, z));
				JournalPage29FinalButtonMessage.handleButtonAction(entity, 8, x, y, z);
			}
		});
		...
		imagebutton_journal_steel_band = new ImageButton(this.leftPos + 282, this.topPos + 93, 128, 24, 0, 0, 24, new ResourceLocation("cemm:textures/screens/atlas/imagebutton_journal_steel_band.png"), 128, 48, e -> {
			if (true) {
				CemmMod.PACKET_HANDLER.sendToServer(new JournalPage29FinalButtonMessage(9, x, y, z));
				JournalPage29FinalButtonMessage.handleButtonAction(entity, 9, x, y, z);
			}
		});
		...
		imagebutton_journal_aluminum_band = new ImageButton(this.leftPos + 282, this.topPos + 67, 128, 24, 0, 0, 24, new ResourceLocation("cemm:textures/screens/atlas/imagebutton_journal_aluminum_band.png"), 128, 48, e -> {
			if (true) {
				CemmMod.PACKET_HANDLER.sendToServer(new JournalPage29FinalButtonMessage(10, x, y, z));
				JournalPage29FinalButtonMessage.handleButtonAction(entity, 10, x, y, z);
			}
		});
