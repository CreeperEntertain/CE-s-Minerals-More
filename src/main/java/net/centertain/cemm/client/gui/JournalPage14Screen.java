...
public class JournalPage14Screen extends AbstractContainerScreen<JournalPage14Menu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("cemm:textures/screens/journal_14.png"), this.leftPos + 136, this.topPos + 0, 0, 0, 146, 180, 146, 180);
	...
	public void init() {
		...
		imagebutton_journal_chlorophyl_band1 = new ImageButton(this.leftPos + 282, this.topPos + 67, 128, 24, 0, 0, 24, new ResourceLocation("cemm:textures/screens/atlas/imagebutton_journal_chlorophyl_band1.png"), 128, 48, e -> {
			if (true) {
