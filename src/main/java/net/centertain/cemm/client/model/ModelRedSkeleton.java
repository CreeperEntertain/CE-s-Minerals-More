package net.centertain.cemm.client.model;
...
public class ModelRedSkeleton<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("cemm", "model_red_skeleton"), "main");
	...
	public ModelRedSkeleton(ModelPart root) {
