...
public class RefineryBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public RefineryBlockEntity(BlockPos position, BlockState state) {
		super(CemmModBlockEntities.REFINERY.get(), position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new RefineryInterfaceMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
