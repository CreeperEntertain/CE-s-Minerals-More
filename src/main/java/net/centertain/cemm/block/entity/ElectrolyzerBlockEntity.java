...
public class ElectrolyzerBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public ElectrolyzerBlockEntity(BlockPos position, BlockState state) {
		super(CemmModBlockEntities.ELECTROLYZER.get(), position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new ElectrolyzerInterfaceMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
