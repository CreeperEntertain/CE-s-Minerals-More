...
public class CoalGeneratorBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public CoalGeneratorBlockEntity(BlockPos position, BlockState state) {
		super(CemmModBlockEntities.COAL_GENERATOR.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("coal_generator");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new CoalGeneratorInterfaceMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
