...
public class DarkPurpurPlankFenceGateBlock extends FenceGateBlock {
	public DarkPurpurPlankFenceGateBlock() {
		super(BlockBehaviour.Properties.of().ignitedByLava().instrument(NoteBlockInstrument.BASS)
				...
				.strength(5f).dynamicShape().forceSolidOn(), WoodType.OAK);
	}
}
