...
public class OchrePlasterBrickWallBlock extends WallBlock {
	public OchrePlasterBrickWallBlock() {
		super(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.BASEDRUM)
				...
				.strength(1f, 3f).requiresCorrectToolForDrops().dynamicShape().forceSolidOn());
	}
}
