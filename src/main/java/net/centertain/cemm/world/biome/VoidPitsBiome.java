...
public class VoidPitsBiome {
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-16777216).waterColor(-16777216).waterFogColor(-16777216).skyColor(-16777216).foliageColorOverride(-6710887).grassColorOverride(-6710887)
				...
				.backgroundMusic(new Music(new SoundEvent(new ResourceLocation("cemm:music.warped_framework")), 12000, 24000, true)).ambientParticle(new AmbientParticleSettings(ParticleTypes.END_ROD, 0.0005f)).build();
