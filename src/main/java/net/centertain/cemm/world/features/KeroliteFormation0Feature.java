...
public class KeroliteFormation0Feature extends Feature<NoneFeatureConfiguration> {
	public static KeroliteFormation0Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new KeroliteFormation0Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("cemm:kerolite_formation_0", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("cemm:kerolite_formation_0", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public KeroliteFormation0Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("cemm", "kerolite_formation_0"));
		if (template == null)
			return false;
