...
public class FourmarieriteFormation1Feature extends Feature<NoneFeatureConfiguration> {
	public static FourmarieriteFormation1Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new FourmarieriteFormation1Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("cemm:fourmarierite_formation_1", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("cemm:fourmarierite_formation_1", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public FourmarieriteFormation1Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("cemm", "fourmarierite_formation_1"));
		if (template == null)
			return false;
