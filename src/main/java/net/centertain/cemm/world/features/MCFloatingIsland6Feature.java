...
public class MCFloatingIsland6Feature extends Feature<NoneFeatureConfiguration> {
	public static MCFloatingIsland6Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new MCFloatingIsland6Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("cemm:mc_floating_island_6", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("cemm:mc_floating_island_6", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public MCFloatingIsland6Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("cemm", "mc_floating_island_6"));
		if (template == null)
			return false;
