...
public class ChlorophylDungeonHallFeature extends Feature<NoneFeatureConfiguration> {
	public static ChlorophylDungeonHallFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new ChlorophylDungeonHallFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("cemm:chlorophyl_dungeon_hall", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("cemm:chlorophyl_dungeon_hall", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public ChlorophylDungeonHallFeature() {
		...
		base_blocks = List.of(CemmModBlocks.CHLOROGRASS_BLOCK_DIRT.get(), CemmModBlocks.CHLOROGRASS_BLOCK_STONE.get(), CemmModBlocks.CHLOROGRASS_BLOCK_MOSS.get(), CemmModBlocks.CHLOROGRASS_BLOCK_ANDESITE.get(),
				...
				CemmModBlocks.FIREGRASS_BLOCK_STONE.get(), CemmModBlocks.FIREGRASS_BLOCK_TUFF.get(), Blocks.STONE, Blocks.GRANITE, Blocks.DIORITE, Blocks.ANDESITE, Blocks.DEEPSLATE, Blocks.TUFF, Blocks.DIRT, Blocks.MOSS_BLOCK);
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("cemm", "chlorophyl_dungeon_hall"));
		if (template == null)
			return false;
