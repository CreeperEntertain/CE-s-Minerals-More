...
public class KenhsuiteBoulderFeature extends Feature<NoneFeatureConfiguration> {
	public static KenhsuiteBoulderFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new KenhsuiteBoulderFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("cemm:kenhsuite_boulder", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("cemm:kenhsuite_boulder", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public KenhsuiteBoulderFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("cemm", "kenhsuite_boulder"));
		if (template == null)
			return false;
