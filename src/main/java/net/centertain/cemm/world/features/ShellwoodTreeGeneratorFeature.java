...
import net.centertain.cemm.procedures.ProceduralShellwoodTrunkProcedure;
import net.centertain.cemm.init.CemmModBlocks;

import java.util.Set;
import java.util.List;

public class ShellwoodTreeGeneratorFeature extends Feature<NoneFeatureConfiguration> {
	...
	public ShellwoodTreeGeneratorFeature() {
		super(NoneFeatureConfiguration.CODEC);
		base_blocks = List.of(CemmModBlocks.VIBRATING_PYROXENE.get(), CemmModBlocks.VIBRATING_MOSS.get());
	}
