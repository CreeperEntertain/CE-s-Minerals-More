...
public class AntimonyOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("cemm:antimony_ore", FEATURE,
				new OreConfiguration(List.of(OreConfiguration.target(new BlockStateMatchTest(Blocks.STONE.defaultBlockState()), CemmModBlocks.ANTIMONY_ORE.get().defaultBlockState())), 9));
		PLACED_FEATURE = PlacementUtils.register("cemm:antimony_ore", CONFIGURED_FEATURE,
