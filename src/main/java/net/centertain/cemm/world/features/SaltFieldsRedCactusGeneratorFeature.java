...
public class SaltFieldsRedCactusGeneratorFeature extends Feature<NoneFeatureConfiguration> {
	...
	public SaltFieldsRedCactusGeneratorFeature() {
		super(NoneFeatureConfiguration.CODEC);
		base_blocks = List.of(CemmModBlocks.RED_SALT.get());
	}
