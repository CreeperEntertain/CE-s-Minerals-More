...
public class GrapeGeneratorFeatureFeature extends StructureFeature {
	public GrapeGeneratorFeatureFeature() {
	...
	public boolean place(FeaturePlaceContext<StructureFeatureConfiguration> context) {
		...
		if (!GrapeGeneratorGenerationProcedure.execute(world, x, y, z))
			return false;
