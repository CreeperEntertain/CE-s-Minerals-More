...
public class ChlorophylPortalFeature extends Feature<NoneFeatureConfiguration> {
	public static ChlorophylPortalFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new ChlorophylPortalFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("cemm:chlorophyl_portal", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("cemm:chlorophyl_portal", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public ChlorophylPortalFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("cemm", "chlorophyl_portal"));
		if (template == null)
			return false;
