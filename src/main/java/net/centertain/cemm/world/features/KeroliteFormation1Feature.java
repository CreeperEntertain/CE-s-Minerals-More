...
public class KeroliteFormation1Feature extends Feature<NoneFeatureConfiguration> {
	public static KeroliteFormation1Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new KeroliteFormation1Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("cemm:kerolite_formation_1", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("cemm:kerolite_formation_1", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public KeroliteFormation1Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("cemm", "kerolite_formation_1"));
		if (template == null)
			return false;
