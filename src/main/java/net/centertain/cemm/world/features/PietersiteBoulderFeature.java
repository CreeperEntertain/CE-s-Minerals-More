...
public class PietersiteBoulderFeature extends Feature<NoneFeatureConfiguration> {
	public static PietersiteBoulderFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new PietersiteBoulderFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("cemm:pietersite_boulder", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("cemm:pietersite_boulder", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public PietersiteBoulderFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("cemm", "pietersite_boulder"));
		if (template == null)
			return false;
