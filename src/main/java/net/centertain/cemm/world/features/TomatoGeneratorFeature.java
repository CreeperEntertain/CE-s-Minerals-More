...
public class TomatoGeneratorFeature extends Feature<NoneFeatureConfiguration> {
	public static TomatoGeneratorFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new TomatoGeneratorFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("cemm:tomato_generator", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("cemm:tomato_generator", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
