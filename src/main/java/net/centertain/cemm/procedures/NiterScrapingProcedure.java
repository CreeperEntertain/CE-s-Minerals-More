	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!(entity instanceof Player _plr ? _plr.getAbilities().instabuild : false)) {
			if (!(EnchantmentHelper.getItemEnchantmentLevel(Enchantments.SILK_TOUCH, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)) != 0)) {
				...
				if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == CemmModBlocks.STONE_NITER_DEPOSIT.get()) {
					world.setBlock(new BlockPos(x, y, z), Blocks.STONE.defaultBlockState(), 3);
				} else if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == CemmModBlocks.GRANITE_NITER_DEPOSIT.get()) {
					world.setBlock(new BlockPos(x, y, z), Blocks.GRANITE.defaultBlockState(), 3);
				} else if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == CemmModBlocks.ANDESITE_NITER_DEPOSIT.get()) {
					world.setBlock(new BlockPos(x, y, z), Blocks.ANDESITE.defaultBlockState(), 3);
				} else if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == CemmModBlocks.DIORITE_NITER_DEPOSIT.get()) {
					world.setBlock(new BlockPos(x, y, z), Blocks.DIORITE.defaultBlockState(), 3);
				} else if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == CemmModBlocks.DEEPSLATE_NITER_DEPOSIT.get()) {
					world.setBlock(new BlockPos(x, y, z), Blocks.DEEPSLATE.defaultBlockState(), 3);
				} else if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == CemmModBlocks.TUFF_NITER_DEPOSIT.get()) {
					world.setBlock(new BlockPos(x, y, z), Blocks.TUFF.defaultBlockState(), 3);
				} else if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == CemmModBlocks.DRIPSTONE_NITER_DEPOSIT.get()) {
