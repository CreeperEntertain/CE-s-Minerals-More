...
public class GrapeGeneratorGenerationProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (height == 3) {
			if (Math.random() <= 0.5) {
				world.setBlock(new BlockPos(x, y + 1, z), CemmModBlocks.GRAPE_GRID_00.get().defaultBlockState(), 3);
			} else {
				world.setBlock(new BlockPos(x, y + 1, z), CemmModBlocks.THREAD_GRID.get().defaultBlockState(), 3);
			}
			if (Math.random() <= 0.5) {
				world.setBlock(new BlockPos(x, y + 2, z), CemmModBlocks.GRAPE_GRID_00.get().defaultBlockState(), 3);
			} else {
				world.setBlock(new BlockPos(x, y + 2, z), CemmModBlocks.THREAD_GRID.get().defaultBlockState(), 3);
			}
			if (Math.random() <= 0.5) {
				world.setBlock(new BlockPos(x, y + 3, z), CemmModBlocks.GRAPE_GRID_00.get().defaultBlockState(), 3);
			} else {
