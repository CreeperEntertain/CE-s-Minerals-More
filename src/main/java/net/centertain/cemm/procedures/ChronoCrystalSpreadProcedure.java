...
public class ChronoCrystalSpreadProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		} else if ((world.getBlockState(new BlockPos(x, y + 1, z))).getBlock() == CemmModBlocks.SMALL_CHRONOCRYSTAL_BUD.get()) {
			{
				BlockPos _bp = new BlockPos(x, y + 1, z);
		...
		} else if ((world.getBlockState(new BlockPos(x, y + 1, z))).getBlock() == CemmModBlocks.MEDIUM_CHRONOCRYSTAL_BUD.get()) {
			{
				BlockPos _bp = new BlockPos(x, y + 1, z);
		...
		} else if ((world.getBlockState(new BlockPos(x, y + 1, z))).getBlock() == CemmModBlocks.LARGE_CHRONOCRYSTAL_BUD.get()) {
			{
				BlockPos _bp = new BlockPos(x, y + 1, z);
