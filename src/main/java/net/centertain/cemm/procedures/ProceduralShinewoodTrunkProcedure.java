...
public class ProceduralShinewoodTrunkProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		world.setBlock(BlockPos.containing(x, y, z), CemmModBlocks.SHINEWOOD_LOG.get().defaultBlockState(), 3);
		XPos2 = XPos;
		YPos2 = YPos;
		ZPos3 = ZPos;
		for (int index0 = 0; index0 < (int) Height; index0++) {
			if ((world.getBlockState(BlockPos.containing(XPos2, YPos2, ZPos3))).is(BlockTags.create(new ResourceLocation("minecraft:leave_blocks"))) || (world.getBlockState(BlockPos.containing(XPos2, YPos2, ZPos3))).getBlock() == Blocks.AIR) {
				world.setBlock(BlockPos.containing(XPos2, YPos2, ZPos3), CemmModBlocks.SHINEWOOD_LOG.get().defaultBlockState(), 3);
			}
			YPos2 = YPos2 + 1;
		}
		XPos2 = XPos + 1;
		...
		ZPos3 = ZPos;
		XPos2 = XPos;
		ShinewoodTrunkPlacementProcedure.execute(world, XPos2, (HeightLocal - 1), ZPos3);
	}
}
