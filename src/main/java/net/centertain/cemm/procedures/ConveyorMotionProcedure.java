...
public class ConveyorMotionProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == CemmModBlocks.CONVEYOR_BOTTOM.get() || (world.getBlockState(new BlockPos(x, y, z))).getBlock() == CemmModBlocks.CONVEYOR_TOP.get()) {
			if ((new Object() {
		...
		} else if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == CemmModBlocks.CONVEYOR_IMPROVED_BOTTOM.get() || (world.getBlockState(new BlockPos(x, y, z))).getBlock() == CemmModBlocks.CONVEYOR_IMPROVED_TOP.get()) {
			if ((new Object() {
				public Direction getDirection(BlockPos pos) {
					BlockState _bs = world.getBlockState(pos);
					Property<?> property = _bs.getBlock().getStateDefinition().getProperty("facing");
		...
		} else if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == CemmModBlocks.CONVEYOR_ADVANCED_BOTTOM.get() || (world.getBlockState(new BlockPos(x, y, z))).getBlock() == CemmModBlocks.CONVEYOR_ADVANCED_TOP.get()) {
			if ((new Object() {
				public Direction getDirection(BlockPos pos) {
					BlockState _bs = world.getBlockState(pos);
					Property<?> property = _bs.getBlock().getStateDefinition().getProperty("facing");
