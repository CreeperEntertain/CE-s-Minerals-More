...
public class PlacedStickTopRightClickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == CemmModItems.TOMATO_SEEDS.get()) {
			...
			world.setBlock(new BlockPos(x, y - 1, z), CemmModBlocks.TOMATO_00_BOTTOM.get().defaultBlockState(), 3);
			world.setBlock(new BlockPos(x, y, z), CemmModBlocks.TOMATO_00_TOP.get().defaultBlockState(), 3);
