...
public class ProceduralEbonyTrunkProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		world.setBlock(new BlockPos(x, y, z), CemmModBlocks.EBONY_LOG.get().defaultBlockState(), 3);
		XPos2 = XPos;
		YPos2 = YPos;
		ZPos3 = ZPos;
		for (int index0 = 0; index0 < (int) (Height); index0++) {
			if ((world.getBlockState(new BlockPos(XPos2, YPos2, ZPos3))).is(BlockTags.create(new ResourceLocation("minecraft:leave_blocks"))) || (world.getBlockState(new BlockPos(XPos2, YPos2, ZPos3))).getBlock() == Blocks.AIR) {
				world.setBlock(new BlockPos(XPos2, YPos2, ZPos3), CemmModBlocks.EBONY_LOG.get().defaultBlockState(), 3);
			}
			YPos2 = YPos2 + 1;
		}
		XPos2 = XPos + 1;
