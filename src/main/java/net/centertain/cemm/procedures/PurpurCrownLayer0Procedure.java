...
public class PurpurCrownLayer0Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		RandomPurpurLeavesProcedure.execute(world, (x - 2), y, (z - 3));
		RandomPurpurLeavesProcedure.execute(world, (x - 1), y, (z - 3));
		RandomPurpurLeavesProcedure.execute(world, x, y, (z - 3));
		RandomPurpurLeavesProcedure.execute(world, (x + 1), y, (z - 3));
		RandomPurpurLeavesProcedure.execute(world, (x + 2), y, (z - 3));
		RandomPurpurLeavesProcedure.execute(world, (x - 3), y, (z - 2));
		RandomPurpurLeavesProcedure.execute(world, (x - 2), y, (z - 2));
		RandomPurpurLeavesProcedure.execute(world, (x - 1), y, (z - 2));
		RandomPurpurLeavesProcedure.execute(world, x, y, (z - 2));
		RandomPurpurLeavesProcedure.execute(world, (x + 1), y, (z - 2));
		RandomPurpurLeavesProcedure.execute(world, (x + 2), y, (z - 2));
		RandomPurpurLeavesProcedure.execute(world, (x + 3), y, (z - 2));
		RandomPurpurLeavesProcedure.execute(world, (x - 3), y, (z - 1));
		...
		RandomPurpurLeavesProcedure.execute(world, (x + 2), y, (z - 1));
		RandomPurpurLeavesProcedure.execute(world, (x + 3), y, (z - 1));
		RandomPurpurLeavesProcedure.execute(world, (x - 3), y, z);
