		...
		if ((new Object() {
				...
				.getItem() == Blocks.AIR.asItem()) {
			{
				BlockEntity _ent = world
						.getBlockEntity(BlockPos.containing(entity.getPersistentData().getDouble("interactedBlockX"), entity.getPersistentData().getDouble("interactedBlockY"), entity.getPersistentData().getDouble("interactedBlockZ")));
				if (_ent != null) {
					final int _slotid = 0;
					final int _amount = 1;
