...
public class SetUpDimensionSkiesProcedure {
	...
	private static void execute(@Nullable Event event) {
		register(ResourceKey.create(Registries.DIMENSION, new ResourceLocation("cemm:icaron")), createOverworldEffects(false, false, true));
		register(ResourceKey.create(Registries.DIMENSION, new ResourceLocation("cemm:the_void")), createOverworldEffects(false, false, true));
	}
}
