...
public class GrapeGridTickUpdateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (world.getMaxLocalRawBrightness(new BlockPos(x, y, z)) >= 7) {
			if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == CemmModBlocks.GRAPE_GRID_00.get()) {
				{
			...
			} else if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == CemmModBlocks.GRAPE_GRID_01.get()) {
				{
					BlockPos _bp = new BlockPos(x, y, z);
			...
			} else if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == CemmModBlocks.GRAPE_GRID_02.get()) {
				{
					BlockPos _bp = new BlockPos(x, y, z);
			...
			} else if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == CemmModBlocks.GRAPE_GRID_03.get()) {
				{
					BlockPos _bp = new BlockPos(x, y, z);
