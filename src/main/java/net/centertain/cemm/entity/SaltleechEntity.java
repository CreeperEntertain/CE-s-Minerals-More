...
public class SaltleechEntity extends Monster {
	public SaltleechEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CemmModEntities.SALTLEECH.get(), world);
	}

	public SaltleechEntity(EntityType<SaltleechEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(1f);
		xpReward = 10;
		setNoAi(false);
